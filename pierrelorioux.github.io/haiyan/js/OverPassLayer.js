...
L.OverPassLayer = L.FeatureGroup.extend({
  ...
  _poiInfo: function(tags,id) {
    var link = '<a href="http://www.openstreetmap.org/edit?editor=id&node='+id+'" target="_blank">Edit this entry in iD</a><br>';
    var r = $('<table>');
    for (key in tags)
  ...
  onMoveEnd: function () {
    ...
    $.ajax({
      url: this.options.query.replace(/(BBOX)/g,"4.0071265,117.71851,18.865073,127.91382"),
